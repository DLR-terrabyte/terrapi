...
terrapi.cli.stac_api_cli.debugCli = True
...
if __name__ == '__main__':
    terrapi.cli.stac_api_cli.login.callback(delete=True)
    terrapi.cli.stac_api_cli.login.callback(valid=True)
    terrapi.cli.stac_api_cli.login.callback()
    #terrapi.cli.stac_api_cli.login.callback(valid=True)
    # print("Test: Create Item")
    #terrapi.cli.stac_api_cli.list_item.callback("di39rer.terrapi4")
    #print("Test: create Collection")
    #terrapi.cli.stac_api_cli.create.callback()
    #terrapi.cli.stac_api_cli.create.callback()
